...
[bastion]# TOWER_GUID=f451
[bastion]# OSP_GUID=2d6e
[bastion]# OPENTLC_LOGIN=ian.wright-mainline.com
[bastion]# OPENTLC_PASSWORD=7W0cS98dm7aS5mxRiBG
[bastion]# GITHUB_REPO=https://github.com/Steeltalon/ansible_advance_homework.git
[bastion]# JQ_REPO_BASE=http://www.opentlc.com/download/ansible_bootcamp
[bastion]# REGION=us-east-1
[bastion]# RH_MAIL_ID=ian.wright@mainline.com
